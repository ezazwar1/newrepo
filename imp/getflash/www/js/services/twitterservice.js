...
.factory('TwitterLib', function ($rootScope, $q, $window, $http, TWITTER_CONFIG, AUTH_EVENTS) {
    ...
    options = angular.extend({}, TWITTER_CONFIG.oauthSettings);
    options = angular.extend(options, {
        callbackUrl: callbackURL
    });

    var twitterKey = AUTH_EVENTS.TWITTERKEY; // This key is used for storing Information related
    ...
    $window.document.addEventListener("deviceready", function () {
        ...
        //callbackURL = TWITTER_CONFIG.oauthSettings.callbackUrl;
