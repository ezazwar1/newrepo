        ...
        return {
            ...
            link: function ($scope, $element, $attributes) {
                ...
                if ($attributes.imageLazyLoader) {
                    if($attributes.imageLazyLoader == "product"){
                        loader = $compile('<img src="img/productplaceholder.jpg" />')($scope);
                    }else if($attributes.imageLazyLoader == "profile"){
                        loader = $compile('<img src="img/profile-ph.jpg" />')($scope);
                    }else if($attributes.imageLazyLoader == "article"){
                        loader = $compile('<img src="img/article-ph.jpg" />')($scope);
                    }else{
                        loader = $compile('<img src="img/preloader.jpg" />')($scope);
                    }
                ...
                $scope.$watch('imageLazySrc', function (oldV, newV) {
                    ...
                    if ($attributes.imageLazyLoader) {
                        if($attributes.imageLazyLoader == "product"){
                            ...
                            loader = $compile('<img src="img/profile-ph.png" />')($scope);
                        }else if($attributes.imageLazyLoader == "article"){
                            loader = $compile('<img src="img/article-ph.jpg" />')($scope);
                        }else{
                            loader = $compile('<img src="img/preloader.jpg" />')($scope);
