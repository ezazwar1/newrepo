 ...
 */
  ...
  Capture.prototype.removeFile = function(successCallback, errorCallback, options){
    _capture("removeFile", successCallback, errorCallback, options);
  };

  cameraPlugin = new Capture();
