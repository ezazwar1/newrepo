 ...
 */
    ...
    return {
      ...
      link:function (scope, element, attrs) {
        ...
        scope.isOpen = function () {
          if(scope.matches) return scope.matches.length > 0;
        };
  ...
  .directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse', function ($http, $templateCache, $compile, $parse) {
    return {
      ...
      link:function (scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || 'templates/typeahead-match.html';
...
angular.module("templates/typeahead-match.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/typeahead-match.html",
    "<a tabindex=\"-1\" bind-html-unsafe=\"match.label | typeaheadHighlight:query\"></a>");
}]);

angular.module("templates/typeahead-popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/typeahead-popup.html",
